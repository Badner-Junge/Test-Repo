    ...
    while repeat == 1:
        ...
        while guess != secret:
            try:
                ...
                print(Fore.RED + "Es sind nur Zahlen erlaubt!")
                clear_line()
                continue
            ...
            if guess == 0:
                ...
                if list.count(guess) == 1:
                    ...
                    if guess < 1000 or guess > 9999:
                        ...
                        if guess < secret + 10:
                            print(Fore.LIGHTYELLOW_EX + "Nah dran" + Fore.RESET + " , aber die gesuchte Zahl ist " + Fore.LIGHTYELLOW_EX + "kleiner!")
                            clear_line()
                        else:
                        ...
                        if guess > secret - 10:
                            print(Fore.LIGHTCYAN_EX + "Nah dran" + Fore.RESET + ", aber die gesuchte Zahl ist " + Fore.LIGHTCYAN_EX + "größer!")
                            clear_line()
                        else:
