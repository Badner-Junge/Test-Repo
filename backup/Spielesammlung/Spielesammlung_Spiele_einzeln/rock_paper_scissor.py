...
while wdh == 1:
    ...
    # Auswertung Modus
        ...
        if win > loose:
            seperator()
            print("Super, du hast " + Fore.GREEN + str(win) + Fore.RESET + " zu " + Fore.RED + str(
                loose) + Fore.RESET + " gewonnen!")
        elif loose > win:
            seperator()
            print("Schade, du hast " + Fore.GREEN + str(win) + Fore.RESET + " zu " + Fore.RED + str(
                loose) + Fore.RESET + " verloren!")
